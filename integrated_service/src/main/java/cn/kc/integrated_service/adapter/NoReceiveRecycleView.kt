 ...
 * 说明：
 */
class NoReceiveRecycleView(private val mContext: Context) :
    RecyclerView.Adapter<NoReceiveRecycleView.ViewHolder>() {

    private var list: List<NoReceiveBean.DataBean>? = null

    private var onItemClick: OnItemClick? = null

    fun setData(list: List<NoReceiveBean.DataBean>) {
        this.list = list
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.item_noreceive_rcy, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Logs.e("地址链接="+data.commanD_FILE_PATH)
...
//        internal var img_one: ImageView
//        internal var img_two: ImageView
//        internal var img_third: ImageView
