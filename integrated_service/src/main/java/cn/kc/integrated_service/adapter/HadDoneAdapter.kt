 ...
 * 说明：
 */
class HadDoneAdapter(private val mContext: Context)
    :RecyclerView.Adapter<HadDoneAdapter.ViewHolder>(){
    private var list: List<HadDoneBean.DataBean>? = null

    fun setData(list: List<HadDoneBean.DataBean>) {
        this.list = list
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(mContext).inflate(
            R.layout.item_noreceive_rcy,
            parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.btn_command.visibility=View.GONE
    }
