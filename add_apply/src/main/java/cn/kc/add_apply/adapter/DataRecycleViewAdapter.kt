 ...
 * 说明：
 */
class DataRecycleViewAdapter(private val mContext: Context) :
    RecyclerView.Adapter<DataRecycleViewAdapter.ViewHolder>() {
    var dataList: ArrayList<ResponsibleDepartmentBean.DataBean>? = null

    fun setData(data: ArrayList<ResponsibleDepartmentBean.DataBean>) {
        this.dataList = data
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val content = dataList!!.get(position).depT_CODE_NAME
