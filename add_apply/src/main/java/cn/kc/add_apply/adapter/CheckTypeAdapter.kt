 ...
 * 说明：
 */
class CheckTypeAdapter(private val mContext: Context) :
    RecyclerView.Adapter<CheckTypeAdapter.ViewHolder>() {
    var dataList: ArrayList<CheckTypeBean.DataBean>? = null

    fun setData(data: ArrayList<CheckTypeBean.DataBean>) {
        this.dataList = data
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val content = dataList!!.get(position).name
