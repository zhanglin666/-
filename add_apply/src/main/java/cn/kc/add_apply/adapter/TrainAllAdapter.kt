 ...
 * 说明：
 */
class TrainAllAdapter (private val mContext: Context) :
    RecyclerView.Adapter<TrainAllAdapter.ViewHolder>() {
    var dataList: ArrayList<TrainAllBean.DataBean>? = null

    fun setData(data: ArrayList<TrainAllBean.DataBean>) {
        this.dataList = data
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val content = dataList!!.get(position).traiN_NAMES
