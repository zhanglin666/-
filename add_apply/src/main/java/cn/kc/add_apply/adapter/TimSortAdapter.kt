 ...
 * 说明：
 */
class TimSortAdapter (private val mContext: Context) :
    RecyclerView.Adapter<TimSortAdapter.ViewHolder>() {
    var dataList: ArrayList<TimSort.DataBean>? = null

    fun setData(data: ArrayList<TimSort.DataBean>) {
        this.dataList = data
    }
